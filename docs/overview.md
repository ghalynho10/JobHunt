...
The whole v1 loop is built and working: a signed in person enters a profile, searches real listings, sees them ranked with the reasoning shown, clicks through to the real posting, and their application is recorded.
