...
- [ ] `docs/observability/README.md`'s Status section should be rewritten once AC-11's real threshold-breach delivery is proven: it was updated 2026-09-03 to record the four configured monitors and the connected alerts, but the smoke test is still pending and the section says so.
