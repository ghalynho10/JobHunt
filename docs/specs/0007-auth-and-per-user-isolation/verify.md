...
- [x] Production allowlist holds the exact production origin and no wildcard → **P5**, AC-20 · **VERIFIED 2026-08-30**, `jobhunt-prod` Site URL `https://usejobhunt.vercel.app`, exact origin only
