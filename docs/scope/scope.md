...
### 7. Auth & per user isolation · in-progress · GA
...
- [ ] Verify it: `/check verify auth & per user isolation`
- [ ] Test it: `/test auth & per user isolation`
- [ ] Review it (fresh model): `/check review auth & per user isolation`
- [ ] Document it: `/document auth & per user isolation`
